...
WITH base AS (
    SELECT 
        ...
        TRIM(MA."Account_Number")::NUMERIC(6,0) AS "AccountNumber",
        ...
        {{ convert_empty_string_to_null('MA."Business_Name"', 'VARCHAR(100)') }} AS "BusinessName",
        {{ convert_empty_string_to_null('MA."BS_Business_Type"', 'VARCHAR(10)') }} AS "BSBusinessType",
        CASE WHEN MA."Platinum_Account" = 'Y' THEN TRUE ELSE FALSE END AS "PlatinumAccount",
        MA."Number_of_Employees"::NUMERIC(15,0) AS "NumberOfEmployees",
